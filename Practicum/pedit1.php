...
$bar=$_POST['bar'];
$sql1=mysqli_query ($connect,"select * from MyProducts where barcode='$bar'");
...
echo "</div>";	
?>
<form action='pedit2.php' method='post'>
    <input type='text' name='barcode' value='<?php echo $bar; ?>' readonly/>
    <br>
    <input type='text' name='item_name' value='<?php echo $b; ?>'/>
    <br>
    <input type='text' name='manuf' value='<?php echo $c; ?>'/>
    <br>
    <input type='text' name='qty' value='<?php echo $d; ?>'/>
    <br>
    <input type='text' name='price' value='<?php echo $e; ?>'/>
    <br>
