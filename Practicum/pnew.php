...
echo "</div>";	
?>
<form action='pnew1.php' method='post'>
<input type='text' name='bar' placeholder='Barcode' required/>
<br>
<input type='text' name='in' placeholder='Item Name' required/>
<br>
<input type='text' name='mn' placeholder='Manufacturer' required/>
<br>
<input type='text' name='qty' placeholder='Quantity' required/>
<br>
<input type='text' name='pri' placeholder='Price' required/>
<br>
